...
attribute_query_test() ->
    ...
    MyStreamStartSpoon = #xmlstreamstart{name = <<"spoon">>,
                                         attrs = (?MY_SPOON)#xmlelement.attrs},
    ?assertEqual(<<"my">>, exml_query:attr(MyStreamStartSpoon, <<"whose">>)),
    ?assertEqual(undefined, exml_query:attr(MyStreamStartSpoon, <<"banana">>)),
    ?assertEqual('IAmA', exml_query:attr(MyStreamStartSpoon, <<"banana">>, 'IAmA')).
